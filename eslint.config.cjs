module.exports = [
    {
        files: ['**/*.js', '**/*.jsx', '**/*.ts', '**/*.tsx', '**/*.test.js', '**/*.spec.js'],
        languageOptions: {
            ecmaVersion: 2021,
            sourceType: 'module',
            globals: {
    ...
    },
    {
        ...
        rules: {
            ...
            'no-undef': 'error',   // Allow using of global variables in tests
            'prefer-const': 'error', // Leave other rules
            'eqeqeq': 'off', // Allow non-strict comparisons in tests
        },
    },
];